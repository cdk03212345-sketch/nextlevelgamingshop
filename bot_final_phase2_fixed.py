...
if OWNER_ID:
    db.execute("INSERT OR IGNORE INTO admins(tg_id,role) VALUES(?, ?)", (OWNER_ID, "owner"))
for aid in ADMIN_IDS:
    role = "owner" if aid == OWNER_ID else "staff"
    db.execute("INSERT OR IGNORE INTO admins(tg_id,role) VALUES(?, ?)", (aid, role))
db.commit()
